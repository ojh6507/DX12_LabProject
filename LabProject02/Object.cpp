...
void CBarrierObject::UpdateMaterialColor(ID3D12GraphicsCommandList* pd3dCommandList)
{
	XMFLOAT4 xmf4Ambient = XMFLOAT4(0.8f, 0.f, .8f, 0.9f);
	XMFLOAT4 xmf4Diffuse = XMFLOAT4(0.9f, 0.9f, 0.9f, 0.5f);
	XMFLOAT4 xmf4Specular = XMFLOAT4(0.01f, 0.01f, 0.01f, 0.9f);
...
void CBarrierObject::Animate(float fElapsedTime, XMFLOAT4X4* pxmf4x4Parent)
{
	CGameObject::Animate(fElapsedTime);
}
void CBarrierObject::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	OnPrepareRender();

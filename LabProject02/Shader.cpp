...
D3D12_INPUT_LAYOUT_DESC CWireframeShader::CreateInputLayout()
{
	...
	return(CIlluminatedShader::CreateInputLayout());
}

D3D12_SHADER_BYTECODE CWireframeShader::CreateVertexShader()
{
	return(CIlluminatedShader::CreateVertexShader());
}

D3D12_SHADER_BYTECODE CWireframeShader::CreatePixelShader()
{
	return(CIlluminatedShader::CreatePixelShader());
}
...
void CWireframeShader::CreateShader(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature)
{
	CIlluminatedShader::CreateShader(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature);
	
}

void CWireframeShader::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera, int nPipelineState)
{
	OnPrepareRender(pd3dCommandList, nPipelineState);
}

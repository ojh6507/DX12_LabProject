...
D3D12_SHADER_BYTECODE CShader::CompileShaderFromFile(WCHAR* pszFileName, LPCSTR pszShaderName, LPCSTR pszShaderProfile, ID3DBlob** ppd3dShaderBlob)
{
	...
	if (FAILED(hResult)) {
		if (pd3dErrorBlob) {
			...
			OutputDebugStringA(pErrorString); // 이 오류 메시지를 로그로 출력
		...
		return {}; // 실패 시 빈 Shader Bytecode 반환
	}
	...
	if (ppd3dShaderBlob && *ppd3dShaderBlob) {
		...
		// Blob이 NULL이면 빈 Shader Bytecode를 반환
		d3dShaderByteCode = { 0 };
	}
...
D3D12_SHADER_BYTECODE CCrosshairShader::CreateVertexShader()
{
	...
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSProjection", "vs_5_1", &m_pd3dVertexShaderBlob));

}

D3D12_SHADER_BYTECODE CCrosshairShader::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSProjection", "ps_5_1", &m_pd3dPixelShaderBlob));
...
void CCrosshairShader::CreateShader(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature)
{
	...
	if (FAILED(hResult))
	{
		// 오류 처리: 디버그 출력 창에 오류 메시지 출력
		wchar_t errorMsg[256];
		swprintf_s(errorMsg, L"Failed to create graphics pipeline state. HRESULT: 0x%08X\n", hResult);
...
///// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////
//D3D12_INPUT_LAYOUT_DESC CDamageShader::CreateInputLayout()
//{
//	return D3D12_INPUT_LAYOUT_DESC();
//}
//
//D3D12_SHADER_BYTECODE CDamageShader::CreateVertexShader()
//{
//	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSDamage", "ps_5_1", &m_pd3dPixelShaderBlob));
//
//}
//
//D3D12_SHADER_BYTECODE CDamageShader::CreatePixelShader()
//{
//	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSDamage", "ps_5_1", &m_pd3dPixelShaderBlob));
//
//}
//
//D3D12_BLEND_DESC CDamageShader::CreateBlendState()
//{
//	D3D12_BLEND_DESC d3dBlendDesc;
//	::ZeroMemory(&d3dBlendDesc, sizeof(D3D12_BLEND_DESC));
//	d3dBlendDesc.AlphaToCoverageEnable = FALSE;
...
//	d3dBlendDesc.RenderTarget[0].LogicOpEnable = FALSE;
//	// Use source alpha and inverse source alpha for blending
//	d3dBlendDesc.RenderTarget[0].SrcBlend = D3D12_BLEND_SRC_ALPHA;
//	d3dBlendDesc.RenderTarget[0].DestBlend = D3D12_BLEND_INV_SRC_ALPHA;
//	d3dBlendDesc.RenderTarget[0].BlendOp = D3D12_BLEND_OP_ADD;
//
//	// For alpha blending, we can typically use the same blend factors for alpha
//	d3dBlendDesc.RenderTarget[0].SrcBlendAlpha = D3D12_BLEND_ONE;
//	d3dBlendDesc.RenderTarget[0].DestBlendAlpha = D3D12_BLEND_ZERO;
//	d3dBlendDesc.RenderTarget[0].BlendOpAlpha = D3D12_BLEND_OP_ADD;
//
...
//}
//
//void CDamageShader::CreateShader(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature)
//{
//	
//}
//
//void CDamageShader::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera, int nPipelineState)
//{
//	//CShader::Render(pd3dCommandList, pCamera, nPipelineState);
//}

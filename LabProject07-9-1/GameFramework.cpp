...
void CGameFramework::BuildObjects()
{
	...
	m_pCrosshair->SetMesh(m);
	m_pCrosshair->SetShader(CMaterial::m_pCrosshairShader);


	/*m = new CHpBarMesh(m_pd3dDevice, m_pd3dCommandList);
	m_pHPBar->SetMesh(m);
...
void CGameFramework::ProcessInput()
{
	...
	auto pos = m_pPlayer->GetPosition(); // 플레이어의 현재 위치
	float terrainHeight = m_pTerrain->GetHeight(pos.x / m_xmf3TerrainScale.x, pos.z / m_xmf3TerrainScale.z); // 지형의 높이를 구함
	pos.y = terrainHeight;
